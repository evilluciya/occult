#Каббалистический / магический квадрат Марса для усиления чакр, укрепления пораженного Марса, 
#и для помощи в исцелении и общем духовном развитии, связанным с Марсом
#Для дел духовных
import time
import os
